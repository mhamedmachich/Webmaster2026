...
export const CLUBS = [
  ...
  { id:5, name:"Environmental Club", school:"Middletown High School", type:"Community", members:29, meeting:"Fridays 3pm", icon:"hands", color:C.green, desc:"Campus sustainability projects, community clean-ups, and environmental advocacy." },
  { id:6, name:"Debate Team", school:"Middletown High School", type:"Academic", members:22, meeting:"Tuesdays 4pm", icon:"message", color:C.coral, desc:"Competitive debate including Lincoln-Douglas, Policy, and Public Forum formats." },
];
